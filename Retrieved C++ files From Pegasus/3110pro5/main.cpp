...
int a = i;
  ...
  cout << p[i] << endl;
    ...
    case 7:
    	...
    	break;
    case 8:
    	out << "Opcion 8 elegida." << endl;
    	if(a != 0){
    		MenuModify(p,opc,a);
    		modificar(p,opc, a);
		}
		else{
			cout << "ERROR! Lista esta vacia. No se puede modificar numeros." << endl;
		}
    	
    	break;
    case 9: 
    	out << "Opcion 9 elegida." << endl;
    	if(a!=0){
    		MenuModify(p,opc,a);
    		eliminar(p, opc, a);
		}
		else{
			cout << "ERROR! Lista esta vacia. No se puede eliminar numeros." << endl;
		}
