...
void ParOrdenado<T>::agregar_final(int& max ){
	...
	cout << "Introduzca numeros o caracteres de un par ordenado, separados por un espacio, para agregarlo a la lista." << endl;
	cin >> number1 >> number2;
...
void ParOrdenado<T>::agregar(int& max){
	...
	do{
		mostrar();
		cout << "Eliga un numero marcando el par ordenado que desea anadir. " << endl;
		cin >> x;
	...
	cout << "Escribir numeros, separado por un espacio, despue aprete enter" << endl;
	cin >> a >> b;
...
void ParOrdenado<T>::eliminar(int& max){
	...
	if(IsEmpty()){
		...
		do{
			mostrar();
			cout << "Eliga un numero marcando el par ordenado que desea eliminar. " << endl;
			cin >> x;
